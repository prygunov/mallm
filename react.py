...
if __name__ == "__main__":
    question = "Открой сайт супермаркета Перекрёсток (perekrestok.ru), найди товар молоко через поиск или в каталоге, выбери один из вариантов и добавь его в корзину."
